...
import { RegisterResponseInterface } from 'src/app/types/auth.interface';
import { ValidatePassword } from 'src/app/validators/validate-password';
    ...
    if (this.form.valid) {
      ...
      this.authService
        .register({
          ...
          password: this.form.value.PasswordValidation.password,
        })
        .subscribe({
          next: (res: RegisterResponseInterface) => {
            console.log(res);
